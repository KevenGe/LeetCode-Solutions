# 该问题直接枚举即可，参考了官方题解
# https://leetcode.cn/problems/number-of-valid-move-combinations-on-chessboard/solutions/2995574/qi-pan-shang-you-xiao-yi-dong-zu-he-de-s-83cm/
        ...
        def dfs(u):
            ...
            for dire in directions:
                for step in range(1, 8):
                    ...
                    stack.append(
                        Movement(
                            positions[u][0], positions[u][1], x, y, dire[0], dire[1]
                        )
                    )
                    if check(u):
                        dfs(u + 1)
